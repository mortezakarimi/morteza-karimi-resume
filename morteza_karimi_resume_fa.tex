...
\section{تجربیات}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {شهریور ۱۳۹۶ - تاکنون}		
      \resumeItemListStart
      	\resumeItem{پیاده‌سازی پرتال شرکت کاما پوستر}{طراحی پرتال با استفاده از فریمورک \lr{Yii2}}
		\resumeItem{پیاده‌سازی پرتال داخلی بیمه آسیا شعبه سبزوار}{طراحی پرتال با استفاده از فریمورک \lr{Yii2}}
