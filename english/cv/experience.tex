...
{Rayanet - Leadecademy} % Organization
{Utrecht, Netherlands (Remote)} % Location
{\shortmonthname[03]. 2025 - \shortmonthname[11]. 2025} % Date(s)
{
	\begin{cvitems} % Description(s) of tasks/responsibilities
		\item {Define and implement LeadEcademy’s technical roadmap and development strategy.}
		\item {Lead backend, frontend, infrastructure, and integrations with a focus on scalability and quality.}
		\item {Architect secure, modular systems that support enterprise-grade digital learning programs.}
		\item { Mentor the engineering team and establish high standards for code quality, workflows, and best practices.}
		\item {Improve development processes, deployment pipelines, and operational reliability.}
		\item {Collaborate cross-functionally to translate complex educational programs into digital-first solutions.}
		\item {Introduce modern tools, frameworks, and AI-enhanced functionalities to elevate the platform experience.}
		\item{Ensure strong performance, monitoring, security, and platform stability.}
		\item{Support the digital transformation of specialized curricula, including Logotherapy’s European expansion.}
	\end{cvitems}
}
